...
##    <script type="text/javascript" src="${request.static_url('uik_ru:static/js/uik/uik.subscriber.js')}"></script>
...
##    <script type="text/javascript" src="${request.static_url('uik_ru:static/js/uik/uik.map.url.js')}"></script>
##    <script type="text/javascript" src="${request.static_url('uik_ru:static/js/uik/uik.map.history.js')}"></script>
...
##    <script type="text/javascript" src="${request.static_url('uik_ru:static/js/uik/uik.uiks.url.js')}"></script>
...
<div id="scale-panel">
	<table style="width: 100%">
		...
		<tr><td><a class="village" href="javascript:void(0)" title="Zoom x13"/>Села</a></td>
